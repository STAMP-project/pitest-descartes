...
public class MethodInfo extends ElementInfo {
    ...
    public MethodInfo(Method method) {
        //TODO: Validate
        super(method.getModifiers(), method.getName(), method.toGenericString()); //TODO: to Generic string?
        ...
        exceptions =   Stream.of(method.getExceptionTypes()).map(Type::getType).collect(Collectors.toSet());
    }
    ...
    public Set<Type> getExceptions() { return exceptions; }

    public TypeInfo getOwner() { return owner; }

    public String getDescriptor() { return descriptor; }

    public boolean isConstructor() { return name.equals("<init>"); }

    public boolean hasNoCode() { return hasFlag(Opcodes.ACC_NATIVE | Opcodes.ACC_ABSTRACT); }
