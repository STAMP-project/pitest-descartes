...
public class MutationPointFinder extends BaseClassVisitor {
  ...
  public MutationPointFinder(
      Predicate<MethodInfo> excludedMethods, Collection<MutationOperator> operators) {
    super();
  ...
  private void registerMutations(
      MethodInfo method, Set<MutationOperator> operators, LineCounter lines) {
