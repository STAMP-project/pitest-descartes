...
/**
 * Utility class to handle the interaction between primitive types and their wrappers Part of the
 * code inspired by/taken from <a href="https://github/google/guava">Google Guava</a>.
 */
public final class TypeHelper {
  ...
  public static Class<?> wrap(Class<?> type) {
    return (type.isPrimitive()) ? PRIMITIVE_TO_WRAPPER_MAP.get(type) : type;
  }

  public static Class<?> unwrap(Class<?> type) {
    return isWrapperType(type) ? WRAPPER_TO_PRIMITIVE_MAP.get(type) : type;
  }
}
