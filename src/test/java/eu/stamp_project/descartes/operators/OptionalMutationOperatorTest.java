...
class OptionalMutationOperatorTest extends ParameterlessOperatorTest<OptionalMutationOperator> {
  ...
  private void checkOriginalValueIsNotEmpty() {
    ...
    assertTrue(
        originalValue.isPresent(),
        "Method getOptionalCalculator in Calculator class must not return an empty Optional");
  }

  private void checkMutatedMethodReturnsEmptyOptional()
