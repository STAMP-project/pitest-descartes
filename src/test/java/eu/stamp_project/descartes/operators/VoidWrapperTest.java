...
class VoidWrapperTest extends MutationOperatorTest {
    ...
    private MutationOperator getOperator() { return new NullMutationOperator(); }
    ...
    @Test
    void testSideEffectsRemovedInMutation() throws NoSuchMethodException, IOException, InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchFieldException {
    ...
    private void checkOriginalSideEffect() {
        ...
        obj.nextOdd();
        assertNotEquals(initialValue, obj.count, "Method nextOdd in SideEffect test class has no effect on the count field");
    }

    private void checkSideEffectsRemoved() throws NoSuchMethodException, IOException, IllegalAccessException, InstantiationException, InvocationTargetException, NoSuchFieldException {
        Method method = getMethod();
