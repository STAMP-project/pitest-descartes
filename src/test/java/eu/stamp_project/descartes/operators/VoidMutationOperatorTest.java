...
class VoidMutationOperatorTest extends ParameterlessOperatorTest<VoidMutationOperator>{
    ...
    @Override
    Stream<Method> methodsToAvoid() throws NoSuchMethodException { return fromClass(Calculator.class).method("getCeiling").toStream(); }

    @Test
    void testRemoveSideEffects() throws NoSuchMethodException, IOException, IllegalAccessException, InvocationTargetException, InstantiationException, NoSuchFieldException {
    ...
    private void checkThereIsASideEffect() {
        ...
        instance.increment();
        assertThat("No detected side effect from method increment in class SideEffect. Value of field count remains the same after method invocation",
                instance.count, is(not(initialValue)));
    }

    private void checkSideEffectWasRemoved() throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException, NoSuchFieldException, IOException {
