...
public class MethodRecordTest {
    ...
    public void shouldHaveTheRightClassification(MethodClassification expectedClassification, MethodRecord record) {
    ...
    public Stream<DynamicTest> shouldNotYieldValidRecords() {
        ...
        return invalidStatusCombinations().map(
                combination ->
                        DynamicTest.dynamicTest(Arrays.toString(combination),
                                () -> assertThrows(
