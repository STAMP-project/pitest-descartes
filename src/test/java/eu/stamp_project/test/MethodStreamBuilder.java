...
public final class MethodStreamBuilder {

  private final Class<?> methodOwner;
  private final List<Method> methodsToReturn;
  ...
  public MethodStreamBuilder method(String name, Class<?>... parameterTypes)
  ...
  public MethodStreamBuilder except(String name, Class<?>... parameterTypes)
      throws NoSuchMethodException {
    exceptions.add(methodOwner.getMethod(name, parameterTypes));
    return this;
  }

  public Stream<Method> toStream() {
    return methodsToReturn.stream().filter(method -> !exceptions.contains(method));
  }

  public static MethodStreamBuilder fromClass(Class<?> methodOwner) {
    return new MethodStreamBuilder(methodOwner);
  }
