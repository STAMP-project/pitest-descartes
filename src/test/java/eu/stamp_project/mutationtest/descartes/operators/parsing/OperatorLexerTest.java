...
public class OperatorLexerTest {
    ...
    public void shouldMatchConstantTokens() {
        TokenType[] types = { TokenType.VOID_KWD, TokenType.NULL_KWD, TokenType.THIS_KWD, TokenType.TRUE_KWD,
                TokenType.FALSE_KWD, TokenType.EMPTY_KWD, TokenType.LPAR, TokenType.BYTE_KWD, TokenType.RPAR,
                TokenType.SHORT_KWD, TokenType.NEW_KWD, TokenType.OPTIONAL_KWD, TokenType.EOF };
    ...
    public void shouldMatchStringLiterals() {
        String[] inputs = { "\"This is a string\"", "\"\\123\"", "\"\\uFFAA\"" };
        String[] values = { "This is a string", "\123", "\uFFAA" };
