...
1. Descartes is a plugin for PIT so they have to be used together. To configure PIT to use Descartes modify the pom.xml of the project adding this configuration (or copy [this file](https://github.com/STAMP-project/dhell/blob/master/pom.xml.for_descartes) to dhell folder and rename it to pom.xml)
